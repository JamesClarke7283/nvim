  ...
  -- ThePrimeagen's 99 AI agent
 	{
		...
		config = function()
			...
			_99.setup({
                -- provider = _99.Providers.ClaudeCodeProvider,  -- default: OpenCodeProvide
                model = "ollama-cloud/minimax-m3",  -- ← here, inside setup()
				logger = {
					level = _99.DEBUG,
     ...
     -- ThePrimeagen's 99 is a prompt buffer based AI agent, configured here with
     -- custom rules, debug logging, and visual-mode keymaps for triggering requests.
